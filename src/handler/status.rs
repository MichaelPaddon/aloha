...
//
// HTML uses a sticky sidebar navigation (matching the aloha docs
...
<aside class="sidebar">
  ...
  <div class="sidebar-footer">aloha v{version}</div>
</aside>
