...
///
/// ACME mode falls back to a self-signed cert if the initial issuance
/// fails; renewal continues in the background regardless.  Static cert
/// paths seed the watch channel once and never update it.
